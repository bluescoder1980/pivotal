...
namespace TICQAPBSComms
{
    ...
    public class PBSComms
    {
        ...
        public void FillDataClass(ref object DataClass)
        {
            try
            {
        ...
        public string GetResponseNewRecordId()
        {
        ...
        public ArrayList GetSearchRecordIds()
        {
        ...
        public int GetResponseErrorNumber()
        {
            int errorNumber = 0;
            try
            {
        ...
        public void AddRequestHeader(string System)
        {
            try
            {
        ...
        public void AddRequestCommandStart(CommandType Command, ref string[] CommandParameters, string Target)
        {
            try
            {
                switch (Command)
        ...
        /// </summary>
        /// <param name="Command">Command Type</param>
        public void AddRequestCommandEnd(CommandType Command)
        {
            try
            {
                switch (Command)
        ...
        public void AddSegmentUpdateStart(string SegmentName)
        {
            try
            {
        ...
        /// <summary>
        /// Added for QA Integration.  PBS XML Command for secondary segments.
        /// Applicable for Active Forms with secnodary segments defined.
        /// </summary>
        /// <param name="SegmentName"></param>
        public void TICAddSecondarySegmentUpdateStart(string SegmentName)
        {
            try
            {
                xmlRequest.Append("<segmentUpdate>");
                xmlRequest.Append("<segmentName>" + SecurityElement.Escape(SegmentName) + "</segmentName>");
                xmlRequest.Append("<secondaryUpdate>");
            }
            catch (Exception ex)
            {
                ExceptionHandler exHandler = new ExceptionHandler();
        ...
        public void AddFieldUpdate(string FieldName, string FieldValue)
        {
            try
            {
        ...
        /// segments defined.
        /// </summary>
        public void AddSegmentUpdateEnd()
        {
            try
            {
                xmlRequest.Append("</primaryUpdate>");
        ...
        /// <summary>
        /// Added for QA Integration.  PBS XML end command for secondary segments 
        /// in a form.  Applicabale for Active forms with secondary segments.
        /// </summary>
        public void TICAddSecondarySegmentUpdateEnd()
        {
            try
            {
                xmlRequest.Append("</secondaryUpdate>");
        ...
        public void AddCondition(string[] FieldName, PBSComms.ConditionType[] Operator, string[] FieldValue)
        {
            try
            {
        ...
        public void AddRequestRecordSource(string RecordId)
        {
            try
            {
        ...
        /// <param name="CommandParameters">Parameters,if any</param>
        public void SearchesXMLCommand(string System, string SearchID, string SRLID, string[] CommandParameters)
        {
            try
            {
                long i = 0;

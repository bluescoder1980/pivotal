...
// $Revision: 147$
// $Author: RYong$
// $Date: Thursday, September 13, 2007 5:45:31 PM$
//
...
namespace CdcSoftware.Pivotal.Applications.HomeBuilders.EF.Server
{
    ...
    public partial class EnvisionIntegration : IRAppScript
    {
        ...
        internal enum ProductCreationLevel
        {
            Corporate,
            Region,
            Division
        ...
        delegate OrganizationTypeInventory UpdateCommunity(object communityId);
        /// <summary>
        ...
        delegate InventoryType UpdateRelease(object releaseId);
        /// <summary>
        ...
        /// <returns>An instance of OrganizationTypeInventory.  Used if the transport is ftp.</returns>
        delegate InventoryType UpdatePlan(object planId, object currentContextReleaseId);
        /// <summary>
        ...
        delegate DesignOptionType UpdateOption(Recordset optionRst);
        /// <summary>
        ...
        delegate OptionAssignmentType[] UpdateOptionAssignments(object planId, Recordset20 currentContextReleaseRst);
        /// <summary>
        ...
        delegate InventoryTypeIntersectionRule UpdateIntersectionRule(Recordset20 hardRuleRst, Recordset20 planAssignmentRst, Recordset20 currentContextReleaseRst, bool softDeactivate);
        /// <summary>
        ...
        delegate RoomType[] UpdateRooms(object planAssignmentId, object planId, Recordset20 currentContextReleaseRst);
        /// <summary>
        ...
        /// <returns>An array of instances of OptionAssignmentType.  Used if the transport is ftp.</returns>        
        delegate OptionAssignmentType[] UpdateRoomOptionAssignments(object locationId, object planAssignmentId, Recordset20 currentContextReleaseRst);
        ...
        private int SendInventoriesToEnvision(object[] arrDivisionIds, bool sendFtpFile)
        
   {
        ...
        private OrganizationType[] ProcessRegions(object[] arrDivisionIds)
        {
            Recordset regionRst;
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        private OrganizationType[] ProcessDivisions(object regionId, ArrayList arrDivsForRegion)
        {
        ...
        private OrganizationTypeInventory[] ProcessCommunities(object divisionId)
        {
            ...
            if (communityRst.RecordCount > 0)
            {
                ...
                while (!communityRst.EOF)
                {
                    try
                    {
                        ...
                        else if (TypeConvert.ToBoolean(communityRst.Fields[NeighborhoodData.InactiveField].Value))
                        {
                            // If the community is inactive and has no sync record, simply don't sync this community.
                            communityChanges = false;
                        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1305:SpecifyIFormatProvider", MessageId = "System.String.Format(System.String,System.Object,System.Object)"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1305:SpecifyIFormatProvider", MessageId = "System.String.Format(System.String,System.Object)"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        private InventoryType[] ProcessReleases(object communityId)
        {
            ...
            releaseRst = this.PivotalDataAccess.GetRecordset(NBHDPhaseData.QueryReleasesToSynchronizeForCommunity, 1, communityId,
                   NBHDPhaseData.RegionIdField, NBHDPhaseData.DivisionIdField, NBHDPhaseData.NeighborhoodIdField,
            ...
            if (releaseRst.RecordCount > 0)
            {
                ...
                while (!releaseRst.EOF)
                {
                    try
                    {
                        ...
                        else if (TypeConvert.ToBoolean(releaseRst.Fields[NBHDPhaseData.InactiveField].Value))
                        {
                            // If the release is inactive and has no sync record, simply don't sync this release.
                            releaseChanges = false;
                        }
                        ...
                        if (releaseChanges)
                        {
                            ...
                            if (iRelease != null)
                            {
                                ...
                                if (!iRelease.Deactivate)
                                    iRelease.Inventory = ProcessPlanAssignments(releaseRst);
                            }
                        }
                        else if (!TypeConvert.ToBoolean(releaseRst.Fields[NBHDPhaseData.InactiveField].Value))
                        {   // No changes.  Process plan assignments and see if they have changes.
        ...
        private InventoryType[] ProcessPlanAssignments(Recordset20 currentContextReleaseRst)
        {            
        ...
        private DesignOptionType[] ProcessOptions(object organizationId)
        {
        ...
        private RoomType[] ProcessRooms(Recordset20 planAssignmentRst, Recordset20 currentContextReleaseRst)
        {
            //Delegate instances for plan update
        ...
        /// <returns></returns>
        private OptionAssignmentType[] ProcessRoomOptionAssignments(object locationId, object planAssignmentId, object planId, Recordset20 currentContextReleaseRst)
        {
        ...
        /// <param name="currentContextReleaseRst">If the option assignment is wildcarded, pass in the current release that's being processed.  Do not change cursor position!</param>
        /// <returns></returns>
        private OptionAssignmentType[] ProcessOptionAssignments(Recordset20 rstPlanAssignment, Recordset20 currentContextReleaseRst)
        {
        ...
        private InventoryTypeIntersectionRule[] ProcessIntersectionRules(Recordset20 planAssignmentRst, Recordset20 currentContextReleaseRst)
        {
        ...
        private void SynchronizeHardRules(Recordset20 hardRuleRst, Recordset20 planAssignmentRst,
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        DesignOptionType UpdateOptionFtp(Recordset optionRst)
        {
            try
            {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        OrganizationTypeInventory UpdateCommunityFtp(object communityId)
        {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        InventoryType UpdateReleaseFtp(object releaseId)
        {
            try
            {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        InventoryType UpdatePlanAssignmentFtp(object planAssignmentId, object currentContextReleaseId)
        {
            try
            {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        OptionAssignmentType[] UpdateOptionAssignmentsFtp(object planAssignmentId, Recordset20 currentContextReleaseRst)
        {
            try
            {
        ...
        /// <returns>Array of OptionAssignmentTypes.</returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        OptionAssignmentType[] UpdateRoomOptionAssignmentsFtp(object locationId, object planAssignmentId, Recordset20 currentContextReleaseRst)
        {
            try
            {
        ...
        /// /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        InventoryTypeIntersectionRule UpdateIntersectionRuleFtp(Recordset20 hardRuleRst, Recordset20 planAssignmentRst, Recordset20 currentContextReleaseRst, bool softDeactivate)
        {
            try
            {
        ...
        /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes")]
        RoomType[] UpdateRoomsFtp(object planAssignmentId, object currentContextPlanId, Recordset20 currentContextReleaseRst )
        {
            try
            {
                object currentContextReleaseId = currentContextReleaseRst.Fields[NBHDPhaseData.NBHDPhaseIdField].Value;
        ...
        DesignOptionType UpdateOptionWs(Recordset optionRst)
        {
        ...
        OrganizationTypeInventory UpdateCommunityWs(object communityId)
        {
        ...
        /// 5.9.0     9/13/2007  RYong   Issue 64787: unable to deactivate inventory.
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1305:SpecifyIFormatProvider", MessageId = "System.String.Format(System.String,System.Object)")]
        InventoryType UpdateReleaseWs(object releaseId)
        {
        ...
        /// 5.9.0     9/13/2007  RYong   Issue 64787: unable to deactivate inventory.
        [System.Diagnostics.CodeAnalysis.SuppressMessage ("Microsoft.Globalization", "CA1305:SpecifyIFormatProvider", MessageId="System.String.Format(System.String,System.Object)")]
        InventoryType UpdatePlanAssignmentWs(object planAssignmentId, object currentContextReleaseId)
        {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1305:SpecifyIFormatProvider", MessageId = "System.String.Format(System.String,System.Object)")]
        OptionAssignmentType[] UpdateOptionAssignmentsWs(object planAssignmentId, Recordset20 currentContextReleaseRst)
        {
        ...
        /// <param name="softDeactivate">Indicates to deactivate the rule if no longer applicable to the plan inventory.</param>
        /// <returns></returns>
        InventoryTypeIntersectionRule UpdateIntersectionRuleWs(Recordset20 hardRuleRst, Recordset20 planAssignmentRst, Recordset20 currentContextReleaseRst, bool softDeactivate)
        {
        ...
        /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1305:SpecifyIFormatProvider", MessageId = "System.String.Format(System.String,System.Object)")]
        RoomType[] UpdateRoomsWs(object planAssignmentId, object planId, Recordset20 currentContextReleaseRst)
        {
        ...
        private bool SuccessfulReturnedXml(XmlNode returnedXml, string[] fatalMessages)
        {
        ...
        private bool MessageIdsInReturnedXml(XmlNode returnedXml, string[] testMessages)
        {
            ArrayList messageIds = new ArrayList();

...
// $Revision: 25$
// $Author: JHui$
// $Date: Wednesday, June 20, 2007 10:14:09 AM$
//
...
namespace CdcSoftware.Pivotal.Applications.HomeBuilders.EF.Server
{
    public partial class EnvisionIntegration : IRAppScript
    {
        ...
        private void AddDivisionsToIntegration(Recordset rstNewDivisions)
        {
        ...
        /// </summary>
        private void SetPendingDivisionsToActivatedFTP()
        {
            string fileName = "";
        ...
        /// </summary>
        private void SetPendingDivisionsToActivatedWS()
        {
        ...
        /// records passed in
        /// </summary>
        private void RemoveDivisionsFromIntegration(Recordset rstSelectedDivisions)
        {
        ...
        private void SetDivisionSetupBeingProcessed(object[] arrDivisionIds)
        {
        ...
        private object GetGeneratedFileList(int ageInDays)
        {
        ...
        ///// <summary>
        ///// Re-send the specified generated file that did not make it to the Envision ftp folder due to transport exceptions.
        ///// </summary>
        ///// <param name="filename">Name of file to re-send.</param>
        //private void ResendGeneratedFile(string filename)
        //{
        //    FtpService ftpObject = new FtpService(this);
        //    ftpObject.Send(@Config.FtpTempDirectory + filename);
        //    //ftpObject.Send("c:\\EnvisionXmlFeedFiles\\" + filename);
        //    Configuration.UpdateCurrentFTPPendingState(m_rdaSystem, filename);
        //}


        private void SendLatestFtpFile()
        {
            new FtpService(this).Send(Config.EnvisionLatestFtpFile);
        }

        ///// <summary>
        ///// This function suspends a specified division from integration.
        ///// </summary>
        ///// <param name="divisionId">Division Id</param>
        ///// <param name="rstActiveContracts">Recordset of contracts that are in progress and preventing a division from being suspended from integration.</param>
        //private bool SuspendIntegration(object divisionId, out Recordset rstActiveContracts)
        //{
        //    rstActiveContracts = PivotalDataAccess.GetRecordset(OpportunityData.QueryAllActiveContractsBeingSyncWithEnvision, 1,
        //        divisionId, OpportunityData.OpportunityIdField, OpportunityData.OpportunityNameField);

        //    if (rstActiveContracts.RecordCount > 0)
        //    {
        //        return false;
        //    }
        //    else
        //    {
        //        SetDivisionEnvisionActivatedFlag(divisionId, false);
        //        return true;
        //    }
        //}
        ...
        /// <returns></returns>
        protected bool OptionAvailableToChangeAllowed(object neighborhoodProdId, string fromOptionAvailableTo, string toOptionAvailableTo, out string warningMessage)
        {
            warningMessage = "";

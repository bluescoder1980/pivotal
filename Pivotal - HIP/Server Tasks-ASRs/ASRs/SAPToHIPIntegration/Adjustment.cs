    ...
    public class Adjustment : IRFormScript
    {
        ...
        public object AddFormData(IRForm pForm, object Recordsets, ref object ParameterList)
        {
            try
            {
                ...
                Opportunity objOpportunity = (Opportunity)mrsysSystem.ServerScripts["TIC Opportunity"].CreateInstance();
                objOpportunity.CalculateTotals(rstPrimary.Fields[IntegrationConstants.strfOPPORTUNITY_ID].Value);                
        ...
        public object DoAdjustmentLookupLogic(Recordset rstPrimary, bool blnIsNewRecord)
        {
            try
            {
                ...
                //AM2011.02.26 - Set Applies_To to "Option"
                rstPrimary.Fields["Apply_To"].Value = "Option";

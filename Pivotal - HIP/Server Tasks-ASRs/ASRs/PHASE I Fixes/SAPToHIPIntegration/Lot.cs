    ...
    public class Lot : IRFormScript
    {
        ...
        public object AddFormData(IRForm pForm, object Recordsets, ref object ParameterList)
        {
            try
            {
                ...
                //AM2010.10.20 - Update Escrow fields if an Escrow record exists in Pivotal
                //AM2010.11.04 - not needed until phase 2
                //this.ManageEscrowFieldsForLot(rstPrimary);
        ...
        protected virtual void DoLotLookupLogic(Recordset rstPrimary, bool blnIsNewRecord)
        {
            try
            {
                ...
                string strExtSrcNeighborhoodCode = TypeConvert.ToString(rstPrimary.Fields[IntegrationConstants.strfLOT_COMMUNITYID].Value).Trim();
                ...
                object vntNeighborhoodId = util.FindNeighborhood(mrsysSystem, strExtSrcNeighborhoodCode, ref strNeighborhoodName);
                ...
                {
                    strErrMsg = "Lot Rejected - No Neighborhood record found for the supplied Construction Project lookup value";
                    throw new PivotalApplicationException(strErrMsg);
                }
                else
                {
                    ...
                    if (Convert.IsDBNull(rstPrimary.Fields[IntegrationConstants.strfNEIGHBORHOOD_ID].Value))
                    {
                        ...
                        rstPrimary.Fields[IntegrationConstants.strfNEIGHBORHOOD].Value = strNeighborhoodName;
                    }
                    else
                    {
                        ...
                        if (!mrsysSystem.EqualIds(rstPrimary.Fields[IntegrationConstants.strfNEIGHBORHOOD_ID].Value, vntNeighborhoodId))
                        {
                ...
                {
                    strErrMsg = "Lot Rejected - No NBHD_Phase (Release Phase) record found for the supplied Neighborhood & Phase lookup values";
                    throw new PivotalApplicationException(strErrMsg);
                }
                else
                {
                ...
                if (!(String.IsNullOrEmpty(strExtSrcPlanCode)))
                {
                    ...
                    {
                        strErrMsg = "Lot Rejected - No Plan record found for the supplied Neighborhood & Plan lookup values";
                        throw new PivotalApplicationException(strErrMsg);
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        util.UpdateInventoryQuote(mrsysSystem, vntInventoryQuoteId, rstPrimary, vntActiveContractOrReservationId);
        ...
        /// </summary>
        /// <param name="rstPrimary"></param>
        protected virtual void ManageEscrowFieldsForLot(Recordset rstPrimary)
        { 
            ...
            // Execute a Query to return the TIC_Construction_Project record with TIC_Construction_Project.External_Source_Community_Id = strExtSrcConstructionProjCode, 
            // returning TIC_Construction_Project_Id and Name fields
            Recordset rstEscrow = objLib.GetRecordset("INT - Escrow By Lot Id ?", 1, rstPrimary.Fields[IntegrationConstants.strfPRODUCT_ID].Value,
                arrFields);
        ...
        /// <param name="vntOpportunityId"></param>
        /// <param name="rstPrimary"></param>
        protected virtual void UpdateContingencyInformation(object vntOpportunityId, Recordset rstPrimary)
        {
            ...
            // Execute a Query to return the TIC_Construction_Project record with TIC_Construction_Project.External_Source_Community_Id = strExtSrcConstructionProjCode, 
            // returning TIC_Construction_Project_Id and Name fields
            Recordset rstCont = objLib.GetRecordset("HB: Contingency for Opp ?", 1, vntOpportunityId,
                IntegrationConstants.strfCONTINGENCY_EXP_DATE, IntegrationConstants.strfCONTINGENCY_TIC_REASON_CODE);

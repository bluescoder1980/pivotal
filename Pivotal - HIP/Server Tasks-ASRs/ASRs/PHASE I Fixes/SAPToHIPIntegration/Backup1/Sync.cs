...
namespace CdcSoftware.Pivotal.Applications.HomeBuilders.EF.Server
{
    ...
    public class Sync : IRAppScript
    {
        ...
        public virtual void SetCurrentFTPSuccessState(string ftpFilename)
        {
        ...
        public virtual void SetNeighborhoodState(object neighborhoodId, byte[] rnUpdateCopy, string ftpFilename)
        {
        ...
        /// <param name="ftpFilename">File name of current daily Ftp update.</param>
        /// <param name="rnUpdateCopy">New Rn_Update value.</param>
        public virtual void SetReleaseState(object releaseId, byte[] rnUpdateCopy, string ftpFilename)
        {
        ...
        /// <param name="rnUpdateCopy">New Rn_Update value.</param>
        /// <param name="ftpFilename">File name of current daily Ftp update.</param>
        public virtual void SetPlanAssignmentState(object planAssignmentId, object currentContextReleaseId, byte[] rnUpdateCopy, string ftpFilename)
        {
        ...
        public virtual void SetHardRuleState(object[,] hardRules, object planId, object currentContextReleaseId, string ftpFilename)
        {
            const int RULE_ID = 0;
        ...
        /// </summary>
        public virtual void DeleteOrphanSyncRecords()
        {
        ...
        public virtual void SetOptionState(object optionId, byte[] rnUpdateCopy, object[,] packageComponents, object[,] optionRules, string ftpFilename)
        {
        ...
        public virtual void SetProductAssignmentState(object optionId, object currentContextPlanId, object currentContextReleaseId, byte[] rnUpdateCopy, string ftpFilename, Boolean softDeactivate)
        {
        ...
        /// <param name="ftpFilename">Current Ftp update filename.</param>
        public virtual void SetLocationProductAssignmentState(object optionId, object locationId, object planId, object currentContextReleaseId, byte[] rnUpdateCopy, bool softDeactivate, string ftpFilename)
        {
            //If sync record exists, update it.  If not, create one.
        ...
        /// <param name="rnUpdateCopy">New Rn_Update value.</param>
        public virtual void SetHomeState(object productId, byte[] rnUpdateCopy)
        {
        ...
        /// <param name="rnUpdateCopy">New Rn_Update value.</param>
        public virtual void SetContactState(object contactId, byte[] rnUpdateCopy)
        {
        ...
        protected virtual void SetSyncState(string query, string[] keyFields, byte[][] keyData, SyncType syncType, bool updateUpdateCopy, byte[] rnUpdateCopy, bool updateSyncState, SyncState syncState)
        {
        ...
        public virtual void SetContractState(object contractId, byte[] rnUpdateCopy, bool contractInactive, SyncState state)
        {
        ...
        public virtual void SetContractState(object contractId, SyncState state)
        {
        ...
        public virtual void SetLoanProfile(object loanProfileId, byte[] rnUpdateCopy)
        {
        ...
        /// <param name="rnUpdateCopy">New sync status</param>
        public virtual void SetLoan(object loanId, byte[] rnUpdateCopy)
        {
        ...
        public virtual void SetLocationState(object locationId, object planId, object currentContextReleaseId, byte[] rnUpdateLocation, byte[] rnUpdateDPLocation, string ftpFilename)
        {

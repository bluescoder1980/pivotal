...
namespace CdcSoftware.Pivotal.Applications.HomeBuilders.EF.Server
{
    ...
    public class SyncProxy
    {
        ...
        public const string SyncASR = "PAHB Envision Sync";
        ...
        public SyncProxy(IRSystem7 rdaSystem)
        {
        ...
        public void SetCurrentFTPSuccessState(string ftpFilename)
        {
        ...
        public virtual void SetLocationState(object locationId, object planId, object currentContextReleaseId, object rnUpdateLocation, object rnUpdateDPLocation, string ftpFilename)
        {
            TransitionPointParameter transitParams = (TransitionPointParameter)m_rdaSystem.ServerScripts[AppServerRuleData.TransitionPointParameterAppServerRuleName].CreateInstance();
            transitParams.Construct();
        ...
        /// </summary>
        public virtual void CleanUpEnvSyncTable()
        {
            TransitionPointParameter transitParams = (TransitionPointParameter)m_rdaSystem.ServerScripts[AppServerRuleData.TransitionPointParameterAppServerRuleName].CreateInstance();
            transitParams.Construct();
            object parameterList = transitParams.ParameterList;
        ...
        /// <param name="ftpFilename">Current Ftp update filename.</param>
        /// <param name="softDeactivate"></param>
        public virtual void SetLocationProductAssignmentState(object optionId, object locationId, object planId, object currentContextReleaseId, object rnUpdateCopy, bool softDeactivate, string ftpFilename)
        {
            TransitionPointParameter transitParams = (TransitionPointParameter)m_rdaSystem.ServerScripts[AppServerRuleData.TransitionPointParameterAppServerRuleName].CreateInstance();
            transitParams.Construct();
            transitParams.SetUserDefinedParameter(1, optionId);
        ...
        /// <param name="contractInactive"></param>
        /// <param name="rnUpdateCopy"></param>
        /// <param name="state"></param>
        public virtual void SetContractState(object contractId, bool contractInactive, byte[] rnUpdateCopy, Sync.SyncState state)
        {
            TransitionPointParameter transitParams = (TransitionPointParameter)m_rdaSystem.ServerScripts[AppServerRuleData.TransitionPointParameterAppServerRuleName].CreateInstance();
            transitParams.Construct();
        ...
        /// <param name="contractId"></param>
        /// <param name="state"></param>
        public virtual void SetContractState(object contractId, Sync.SyncState state)
        {
            TransitionPointParameter transitParams = (TransitionPointParameter)m_rdaSystem.ServerScripts[AppServerRuleData.TransitionPointParameterAppServerRuleName].CreateInstance();
            transitParams.Construct();
            transitParams.SetUserDefinedParameter(1, contractId);
        ...
        public virtual void SetLoanProfileState(object loanProfileId, byte[] rnUpdateCopy)
        {
            TransitionPointParameter transitParams = (TransitionPointParameter)m_rdaSystem.ServerScripts[AppServerRuleData.TransitionPointParameterAppServerRuleName].CreateInstance();
            transitParams.Construct();
        ...
        public virtual void SetLoanState(object loanId, byte[] rnUpdateCopy)
        {
            TransitionPointParameter transitParams = (TransitionPointParameter)m_rdaSystem.ServerScripts[AppServerRuleData.TransitionPointParameterAppServerRuleName].CreateInstance();
            transitParams.Construct();

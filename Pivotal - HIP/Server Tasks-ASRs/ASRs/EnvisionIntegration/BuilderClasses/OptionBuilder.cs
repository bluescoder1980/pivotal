...
namespace CdcSoftware.Pivotal.Applications.HomeBuilders.EF.Server
{
    ...
    public class OptionBuilder : BuilderBase
    {
        ...
        protected virtual ArrayList GetIncludedOptions(object optionId, string LocationNumber, string LocationLevel, DataAccess objLib, IRSystem7 mrsysSystem, EnvisionIntegration.TransportType transportType)
        {
    ...
    protected virtual List<DesignOptionTypeRule> GetOptionRules(ref object[,] optionRuleUpdate, Recordset20 optionRst, string LocationNumber, string LocationLevel, DataAccess objLib, IRSystem7 mrsysSystem)
        {

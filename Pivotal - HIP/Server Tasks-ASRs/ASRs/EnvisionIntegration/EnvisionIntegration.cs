...
namespace CdcSoftware.Pivotal.Applications.HomeBuilders.EF.Server
{
    ...
    public partial class  EnvisionIntegration : IRAppScript
    {
        ...
        public static class LocationLevel
        {
            ...
            internal const string CodeRelease = "pha";
            internal const string CodePlan = "plan";
        ...
        /// </summary>
        public static class OpportunityAsrMethodName
        {
            public const string CreatePostSaleQuote = "CreatePostSaleQuote";
            public const string CreateOpportunityProductOption = "CreateOpportunityProductOption";
            public const string CalculateTotals = "CalculateTotals";
            public const string GetReSelectedOptionPriceAndBuiltInfo = "GetReSelectedOptionPriceAndBuiltInfo";
            //AM2010.08.25 - Added to support accepting Post Sale and Post Build Quotes systematically.
            public const string ApplyPostSaleQuote = "ApplyPostSaleQuote";
        }

        /// <summary>
        /// External ASR Names
        /// </summary>
        public static class AppServerRuleName
        {
            //internal const string OpportunityPostSaleQuote = "PAHB Opportunity Post Sale Quote";
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1823:AvoidUnusedPrivateFields")]
            public const string Opportunity = "PAHB Opportunity";
            public const string EnvisionIntegrationTransactional = "PAHB Envision Integration Transactional";
        }
        ...
        {
            public const string HBPostSaleQuote = "HB Post Sale Quote";
            public const string HBOpportunityOptions = "HB Opportunity Options";
        }
        ...
        #region Statics
        public static bool sendContractsIsRunning = false;  //flags the current running state of the Send Contracts process
        public static bool sendInventoryIsRunning = false;  //flags the current running state of the Send Inventory process
        ...
        /// </summary>
        public virtual ValidateXml XmlValidation
        {
            get
            {
        ...
        /// </summary>
        public virtual ILangDict LangDictionary
        {
            get
            {
        ...
        /// </summary>
        public virtual IRSystem7 PivotalSystem
        {
            get
            {
        ...
        /// </summary>
        public virtual DataAccess PivotalDataAccess
        {
            get
            {
        ...
        /// </summary>
        protected virtual void CleanupLog()
        {
        ...
        /// <summary>
        /// AM2010.08.26 - This method was modified from the original Envision Code
        /// to work with Chateau Design Center instead of Envision
        /// Changed "PROCESS_BUYER_SELECTIONS_QUEUE" to call ProcessOptionSelectionsQueue
            ...
            try
            {
                ...
                switch (MethodName)
                {
                    ...
                    case "PROCESS_BUYER_SELECTIONS_QUEUE":
                        {                            
                            //AM2010.08.24 - Changed to call custom Irvine Co. processing
                            ProcessOptionSelectionsQueue();

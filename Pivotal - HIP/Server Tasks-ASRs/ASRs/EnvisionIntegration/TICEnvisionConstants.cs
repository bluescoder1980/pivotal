...
namespace CdcSoftware.Pivotal.Applications.HomeBuilders.EF.Server
{
    ...
    /// </summary>
    internal static class TICEnvisionConstants
    {
        ...
        public const string strfTIC_COLOR_NOTES = "TIC_Color_Notes";
        public const string strfTIC_STYLE_NOTES = "TIC_Style_Notes";
        public const string strfTIC_LOCATION_NOTES = "TIC_Location_Notes";
        public const string strfTIC_OPTION_NOTES = "OptionNotes";
        ...
        //Opportunity Product
        public const string OPPORTUNITY__PRODUCT_PRICE_MISMATCH = "TIC_Price_Mismatch";

        //Const for Custom option
        public const string strcCUSTOM_OPTION = "Custom Option";

        public const string strcTIC_SHOW_IN_DOCUMENT = "TIC_Show_In_Document";
        ...
        public struct TICIntOptionSelectionsTable
        {
            ...
            public struct TableFields
            {
                ...
                public const string PREPLOT_OPTION = "PrePlot_Option";
            ...
            public struct Queries
            {
                ...
                public const string OPTION_SELECTIONS_PENDING = "TIC : Pending Option Selections";

                public const string TIC_ACTIVE_CHATEAU_PBQs_FOR_IQ = "TIC : Active Post Build Quotes For IQ ? and ExtSrcName = Chateau";
                public const string TIC_ACTIVE_CHATEAU_PSQs_FOR_CONTRACT = "TIC : Active PSQ for contract? and ExtSrcName = Chateau";
                public const string TIC_ACTIVE_NON_CHATEAU_PSQs_FOR_CONTRACT = "TIC : Active PSQ for contract?";
                public const string TIC_ACTIVE_NON_CHATEAU_PBQs_FOR_IQ = "TIC : Active Post Build Quotes For IQ ?";
            }
            ...
            {
                public const string CHATEAU = "Chateau";
                public const string CUSTOM_OPTION_TYPE = "CUSTOM";
            }

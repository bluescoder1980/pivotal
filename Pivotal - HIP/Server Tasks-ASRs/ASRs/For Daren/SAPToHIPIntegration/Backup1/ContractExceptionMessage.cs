...
namespace CdcSoftware.Pivotal.Applications.HomeBuilders.EF.Server
{
    ...
    /// </summary>
    public static class ContractExceptionMessage
    {
        public const string NoInfoAvailable = "N/A";

        /// <summary>
        /// Messages for when new option selections are being added to a contract.
        /// </summary>
        public enum ContractOptionSelectionProcessing
        {
        ...
        /// </summary>
        public enum ContractSendProcessing
        {
            CreateEnvisionHome,
            CreateEnvisionBuyer,
            UpdateEnvisionHome,
        ...
        public static string GetContractOptionsUpdateExceptionMsg(IRSystem7 pivotalSystem, DataAccess pivotalDataAccess, byte[] contractId, int transactionId, ContractOptionSelectionProcessing type)
        {
        ...
        public static string GetContractSendExceptionMsg(IRSystem7 pivotalSystem, DataAccess pivotalDataAccess, byte[] contractId, ContractSendProcessing type)
        {
            string contractIdString = string.Empty;
            string contractDescriptor = string.Empty;
            ...
            switch (type)
            {
                ...
                //case ContractSendProcessing.CloseHome:
                    //return (string)langDictionary.GetTextSub("ExceptionCloseHome", new string[] { contractIdString, contractDescriptor });
            }
            return NoInfoAvailable;
        }

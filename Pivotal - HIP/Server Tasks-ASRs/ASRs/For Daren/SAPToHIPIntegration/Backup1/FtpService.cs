...
namespace CdcSoftware.Pivotal.Applications.HomeBuilders.EF.Server
{
    ...
    public class FtpService
    {
        ...
        public FtpService(EnvisionIntegration envisionIntegration)
        {
        ...
        protected virtual void UploadXmlViaFtp(string filename, string ftpProgPath, string destServer, string destPath, string userName, string password, int timeOut)
        {
            try
            {
        ...
        protected virtual void ftpProcess_OutputDataReceived(object sender, DataReceivedEventArgs e)
        {

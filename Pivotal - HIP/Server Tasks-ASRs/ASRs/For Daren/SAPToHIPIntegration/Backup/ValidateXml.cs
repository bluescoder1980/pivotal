...
// $Revision: 11$
// $Author: RYong$
// $Date: Wednesday, August 22, 2007 4:41:53 PM$
//
...
namespace CdcSoftware.Pivotal.Applications.HomeBuilders.EF.Server
{
    ...
    internal class ValidateXml
    {
        ...
        private const string LangStringValidateXml = "LogInfoValidateXml";
        ...
        {
            internal const string BuyerSelection = "EnvisionBuyerSelections";
            internal const string Buyer = "EnvisionDcmWsBuyer";
            internal const string Home = "EnvisionDcmWsHome";
            internal const string Inventory = "EnvisionOmWsInventory";
            internal const string OptionAssignments = "EnvisionOmWsOptnAssignmnts";
            internal const string Option = "EnvisionOmWsOption";
            //internal const string Rooms = "EnvisionOmWsRooms";
            internal const string LocationReference = "EnvisionWsLocationReference";
            internal const string Output = "EnvisionWsOutput";
            internal const string FtpOption = "EnvisionOption";
        }
        ...
        private static void ValidateXmlAgainstSchema(XmlNode xmlDocument, System.Xml.Schema.XmlSchema xmlSchema)
        {
        ...
        internal ValidateXml(IRSystem7 rdaSystem, Configuration config, Logging log, ILangDict langDictionary)
        {
        ...
        private System.Xml.Schema.XmlSchema LoadSchema(string clientScriptName)
        {
        ...
        internal void BuyerSelections(XmlNode xml)
        {
        ...
        internal void Buyer(XmlNode xml)
        {
            if (this.m_config.ValidateXml)
            {
        ...
        internal void Home(XmlNode xml)
        {
            if (this.m_config.ValidateXml)
            {
        ...
        internal void Inventory(XmlNode xml)
        {
            if (this.m_config.ValidateXml)
            {
        ...
        internal void OptionAssignments(XmlNode xml)
        {
            if (this.m_config.ValidateXml)
            {
        ...
        internal void Option(XmlNode xml)
        {
            if (this.m_config.ValidateXml)
            {
        ...
        ///// Validates Rooms Xml
        ///// </summary>
        ///// <param name="xml">Xml that defines an Envision Rooms entity</param>
        //internal void Rooms(XmlNode xml)
        //{
        //    if (this.m_config.ValidateXml)
        //    {
        //        this.m_log.WriteInformation((string)this.m_langDictionary.GetTextSub(LangStringValidateXml, new string[] { SchemaName.Rooms }));
        //        XmlSchema schema = LoadSchema(SchemaName.Rooms);
        //        ValidateXmlAgainstSchema(xml, schema);
        //    }
        //}
        ...
        internal void LocationReference(XmlNode xml)
        {
            if (this.m_config.ValidateXml)
            {
        ...
        internal void Output(XmlNode xml)
        {
            if (this.m_config.ValidateXml)
            {
        ...
        internal void FtpOption(string fileName)
        {
            if (this.m_config.ValidateXml)
            {

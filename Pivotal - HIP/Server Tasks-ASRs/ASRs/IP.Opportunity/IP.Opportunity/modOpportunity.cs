...
namespace CdcSoftware.Pivotal.Applications.HomeBuilders.EF.Server
{
    internal static class modOpportunity
    {
        ...
        public const string strsHOMESITE = "Homesite";
        public const string strsQUOTE = "Quote";
        public const string strsCANCELLED = "Cancelled";
        //AM2010.10.04 - Added Canceled Reserved status
        public const string strsCANCELLED_RESERVED = "Cancelled Reserve";
        ...
        public const string strsCONVERT_TO_SALE = "Convert to Sale";
        public const string strsTRANSFER_SALE = "Transfer Sale";
        public const string strsTRANSFER_RESERVE = "Transfer Reserve";
        public const string strsROLLBACK = "Rollback";
        public const string strsROLLBACK_SALE = "Rollback Sale";
        public const string strsROLLBACK_RESERVE = "Rollback Reserve";
        ...
        public const string strsTIC_OPPORTUNITY_POST_SALE_QUOTE = "TIC Opportunity Post Sale Quote";
        // Table Name
        ...
        public const string strfTIC_SYNC_TO_SAM = "TIC_Sync_To_SAM";
        ...
        public const string strfTIC_ROLLBACK = "TIC_Rollback";
        public const string strfTIC_ROLLBACK_DATE = "TIC_Rollback_Date";
        public const string strfTIC_TRANSFER = "TIC_Transfer";
        public const string strfTIC_TRANSFER_DATE = "TIC_Transfer_Date";
        public const string strfTIC_ORIGINAL_SALE_DATE = "TIC_Original_Sale_Date";
        public const string strfTIC_ORIGINAL_RESERVATION_DATE = "TIC_Original_Reservation_Date";
        public const string strfTIC_TRANSFER_FROM_LOT_ID = "TIC_Transfer_From_Lot_Id";
        public const string strfTIC_TRANSFER_TO_LOT_ID = "TIC_Transfer_To_Lot_Id";
        public const string strfTIC_CANCELLATION_RESERVATION_DATE = "TIC_Cancel_Reservation_Date";
        public const string strfTIC_ADDITIONAL_PREMIUM_PRICE = "TIC_Additional_Premium_Price";
        ...
        public const string TIC_Decorator_Opt_Cost_Total = "TIC_Decorator_Opt_Cost_Total";
        public const string TIC_Actual_Broker_Commission = "TIC_Actual_Broker_Commission";
        ...
        public const string strfTIC_ESCROW_ID = "TIC_Escrow_Id";

        public const string strqTIC_ESCROW_FOR_OPPORTUNITY_ID = "TIC: Escrow for Opportunity Id?";
        ...
        public const string strfTRANSFER_FROM_LOT_ID = "Transfer_From_Lot_Id";
        public const string strfTRANSFER_TO_LOT_ID = "Transfer_To_Lot_Id";
        ...
        public const string strfTIC_OPTIONED_SQFT = "TIC_Optioned_SqFt";
        ...
        public const string strfTIC_PREPLOT_OPTION = "TIC_Preplot_Option";
        ...
        public const string strqNOTIFICATION_ON_CONVERT_TO_SALE = "TIC Notification on Convert to Sale";
        public const string strqNOTIFICATION_ON_TRANSFER = "TIC Notification on Transfer";
        public const string strqNOTIFICATION_ON_RESERVATION = "TIC Notification on Reservation";
        public const string strqTIC_ALL_SELECTED_OPTIONS_FOR_OPP = "TIC: All Selected Options for Opportunity id?";
        // Report
        ...
        public const string strmGET_ESCROW = "GetEscrow";
        public const string strmROLLBACKS = "Rollbacks";
        public const string strmTRANSFERS = "Transfers";
        public const string strmESCROW_CONTRACT_CLOSE = "EscrowCloseContract";
        public const string strmRESERVATION_CANCELLATION = "ReservationCancellation";
        ...
        public const string strdCONVERT_TO_SALE_SUBJECT = "Convert to Sale Subject";
        public const string strdCONVERT_TO_SALE_MESSAGE1 = "Convert to Sale Message1";
        public const string strdCONVERT_TO_SALE_MESSAGE2 = "Convert to Sale Message2";
        public const string strdCONVERT_TO_SALE_MESSAGE3 = "Convert to Sale Message3";
        public const string strdTRANSFER_SUBJECT = "Transfer Subject";
        public const string strdTRANSFER_MESSAGE1 = "Transfer Message1";
        public const string strdTRANSFER_MESSAGE2 = "Transfer Message2";
        public const string strdTRANSFER_MESSAGE3 = "Transfer Message3";

        public const string strdRESERVATION_SUBJECT = "Reservation Subject";
        public const string strdRESERVATION_MESSAGE1 = "Reservation Message1";
        public const string strdRESERVATION_MESSAGE2 = "Reservation Message2";
        public const string strdRESERVATION_MESSAGE3 = "Reservation Message3";
        ...
        //AM2010.09.08 - Constants added for Calculuation totals
        public const string TIC_Struct_Opt_Deposit_Total = "TIC_Struct_Opt_Deposit_Total";
        public const string TIC_DG_Option_Deposit_Total = "TIC_DG_Option_Deposit_Total";
        public const string TIC_Init_Option_Deposit_Total = "TIC_Init_Option_Deposit_Total";
        public const string TIC_Other_Deposit_Total = "TIC_Other_Deposit_Total";
        public const string TIC_Base_Price_Adj_Total = "TIC_Base_Price_Adj_Total";
        public const string TIC_Decorator_Adj_Total = "TIC_Decorator_Adj_Total";
        public const string TIC_Structural_Adj_Total = "TIC_Structural_Adj_Total";
        public const string TIC_Closing_Cost_Adj_Total = "TIC_Closing_Cost_Adj_Total";
        public const string TIC_Design_Options_Total = "TIC_Design_Options_Total";
        public const string TIC_Structural_Options_Total = "TIC_Structural_Options_Total";
        public const string TIC_Preplot_Options = "TIC_Preplot_Options";
        public const string TIC_Total_Options_Deposits = "TIC_Total_Options_Deposits";
        public const string TIC_Pre_Plotted_Structural_Opt = "TIC_Pre_Plotted_Structural_Opt";
        public const string TIC_Closing_Costs_Adjustments = "TIC_Closing_Costs_Adjustments";
        public const string TIC_Merch_Bond_Adj_Total = "TIC_Merch_Bond_Adj_Total";

        public const string TIC_OPTIONS_BY_CODE_AND_OPPORTUNITY = "TIC : Options By Code_ ? Opportunity ?";

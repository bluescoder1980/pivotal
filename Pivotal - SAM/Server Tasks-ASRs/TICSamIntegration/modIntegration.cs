...
namespace Pivotal.Application.TIC.SAMIntegration
{
    internal class modIntegration
    {
        ...
        public const string TIC_Changed_By_Employee_Id = "TIC_Changed_By_Employee_Id";
        ...
        public const string discTIC_Preplotted_Structural_Option       = "Disconnected_1_2_22";
        public const string discTIC_Selling_Incentive       = "Disconnected_1_2_23";
        public const string discTIC_Transfer = "Disconnected_1_2_24";
        public const string discTIC_Transfer_To_Lot_Id = "Disconnected_1_2_25";
        ...
        public const string TIC_Deleted = "TIC_Deleted";
        public const string TIC_Date_Released = "TIC_Date_Released";
        public const string TIC_Conversion_Indic = "TIC_Conversion_Indic";
        public const string TIC_Transfer = "TIC_Transfer";
        public const string TIC_Transfer_To_Lot_Id = "TIC_Transfer_To_Lot_Id";
        public const string TIC_Transfer_From_Lot_Id = "TIC_Transfer_From_Lot_Id";

        //AM2010.11.10 - Additional fields for SAM Pricing
        public const string TIC_Structural_Option_Preplots = "TIC_Structural_Option_Preplots";
        public const string TIC_Design_Center_Preplots = "TIC_Design_Center_Preplots";
        public const string TIC_Selling_Incentive = "TIC_Selling_Incentive";
        public const string TIC_ICDC_Room_Preplot = "TIC_ICDC_Room_Preplot";
	    
        ////Sale
        public const string TIC_Selling_Room_Preplot = "TIC_Selling_Room_Preplot";
        public const string TIC_Closing_Room_Preplot = "TIC_Closing_Room_Preplot";
        


        public const string strfEMPLOYEE_USER_ID = "Rn_Employee_User_Id";
